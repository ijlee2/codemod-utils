...
const latestVersions = new Map([
  ...
  ['@codemod-utils/blueprints', '2.1.3'],
  ['@codemod-utils/ember', '3.0.7'],
  ['@codemod-utils/files', '3.2.5'],
  ['@codemod-utils/package-json', '3.3.5'],
  ['@codemod-utils/tests', '2.2.4'],
  ['@ijlee2-frontend-configs/changesets', '1.0.2'],
  ['@ijlee2-frontend-configs/eslint-config-node', '2.4.0'],
  ['@ijlee2-frontend-configs/prettier', '2.4.0'],
