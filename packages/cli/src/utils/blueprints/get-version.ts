...
const latestVersions = new Map([
  ...
  ['@codemod-utils/ast-template-tag', '1.1.1'],
  ...
  ['@ijlee2-frontend-configs/changesets', '1.0.1'],
  ['@ijlee2-frontend-configs/eslint-config-node', '2.3.2'],
  ['@ijlee2-frontend-configs/prettier', '2.3.2'],
