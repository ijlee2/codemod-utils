import { type AST, builders as _builders } from '@glimmer/syntax';
...
/**
 * Update glimmer's builders to return our annotated types, so that tests and
 * users can specify formatting properties on constructed nodes.
 */
